...
We value your feedback on the hosted version of Fovi and appreciate any comments, suggestions, or ideas you may have for improving our platform ("Feedback"). By providing Feedback, you grant us a non-exclusive, transferable, worldwide, perpetual, irrevocable, fully-paid, royalty-free license, with the right to sublicense, to use, copy, modify, create derivative works based upon, and otherwise use the Feedback for any purpose. You acknowledge that your Feedback does not contain any confidential or proprietary information belonging to you or any third party. While we welcome your Feedback on the hosted service, you agree that we are not obliged to act on any Feedback you provide. You also agree to indemnify and hold Fovi LLC and its affiliates, officers, agents, employees, and licensors harmless from any claim or demand, including reasonable attorneys’ fees, made by any third party due to or arising out of your Feedback, as set forth in the Indemnification section below.

##### 5. Privacy Policy  \n
At Fovi, we take your privacy very seriously. Our application only uses your OpenAI API Key during sessions to interact with the AI models. To ensure your confidentiality and security, we use a one-way hashing algorithm on your OpenAI Key to generate your unique user identity rather than collecting or storing Personal-Identifiable-Information (PII). We also use a symmetric AES-128 encryption algorithm, with a unique key for each user, to encrypt your chat transcripts with the AI Assistants. Lastly, we do store the AI assistant prompts, which can be reviewed and audited periodically to ensure no misuse. For more information about our privacy practices, please visit our privacy policy.

##### 6. User Conduct  \n
You agree to use Fovi only for lawful purposes and in accordance with these Terms of Service. Specifically, you agree not to: (a) violate any applicable law or regulation; (b) maliciously try to hack or break AI Assistants by using Prompt Injection techniques; (c) share bots that do not meet our user content standard; (d) break the system in any way. You also agree to use Fovi in a responsible and ethical manner and to contribute to an overall positive environment for all users. This includes refraining from any behavior that promotes, incites, or engages in hate speech, discriminatory behavior, or harassment of any kind based on race, gender, sexual orientation, religion, nationality, or any other personal characteristics. This also includes creating and using AI responsibly and ethically.

##### 7. User Content  \n
You retain ownership of all GPT prompts created by you on Fovi. You agree not to create or share AI Assistants that: (a) violate any applicable law or regulation; (b) infringe on the intellectual property, privacy, or other rights of any person, except for prompts that are inspired by existing works or ideas and do not substantially copy the intellectual property of others or violate any intellectual property laws or regulations; (c) impersonate any person or entity in a manner that is intended to deceive or mislead others, unless the impersonation is clearly designated as parody or satire, or has written permission; (d) distribute or post spam, chain letters, or pyramid schemes; (e) promote, incite, or engage in hate speech, discriminatory behavior, or harassment of any kind based on race, gender, sexual orientation, religion, nationality, or any other personal characteristics. Additionally, we recommend that you do not create AI Assistants for use in heavily regulated fields, as the legal and ethical implications of such applications can be complex and far-reaching.

As stated in our Privacy Policy, your user identifier cannot be tied to you but your chat session messages are stored. While the chat session messages are encrypted, you agree you will not provide any PII or Personal Health Information (PHI) during chat sessions. You also grant us a non-exclusive, transferable, worldwide, perpetual, irrevocable, fully-paid, royalty-free license to use, copy, modify, create derivative works based upon, and otherwise use the content for improving our platform and any other potential purposes. Finally, you agree to indemnify and hold Fovi LLC and its affiliates, officers, agents, employees, and licensors harmless from any claim or demand, including reasonable attorneys’ fees, made by any third party due to or arising out of any content you provide, as set forth in the Indemnification section below.

##### 8. Use of AI Assistants in Sessions  \n
Fovi provides a platform for creating and interacting with AI Assistants powered by OpenAI's GPT language model. **While we strive to provide a safe and user-friendly experience, we cannot guarantee the accuracy or reliability of the AI Assistants created on our platform. Any advice or guidance provided by the AI Assistants should be treated as entertainment purposes only and should be taken with a grain of salt. We will not be liable for any decisions made by users based on that advice.**

As discussed in the User Content section, you agree not to provide any PII or PHI to the AI Assistants during these sessions. Please be aware that your session messages are transmitted to OpenAI's models and are recorded on our server (your user identifier cannot be tied to you and your session messages are stored encrypted). While we take appropriate measures to secure your information, we cannot guarantee the absolute security of your data. Therefore, we recommend that you do not provide any sensitive or confidential information during the chat sessions. By using the AI Assistants on our platform, you acknowledge and accept these risks. You also agree to indemnify and hold Fovi LLC and its affiliates, officers, agents, employees, and licensors harmless from any claim or demand, including reasonable attorneys’ fees, made by any third party due to or arising out of any chat sessions you participate in or any decisions you make based on the AI Assistants, as set forth in the Indemnification section below. 

##### 9. Termination and Suspension  \n
We reserve the right to terminate or suspend your access to Fovi, without notice or liability, for any reason whatsoever, including, but not limited to, a breach of these Terms of Service, and we also reserve the right to stop providing the service without advance notice. All provisions of these Terms which by their nature should survive termination shall survive, including, without limitation, ownership provisions, warranty disclaimers, indemnity, and limitations of liability.

You agree that Fovi LLC shall not be liable to you or any third party for any termination of your access to Fovi or for the discontinuation of the service. Upon termination or discontinuation, your right to use Fovi will immediately cease, and you must cease all use of Fovi and delete any stored data or information associated with it.

##### 10. Limitation of Liability  \n
Fovi LLC is not responsible for any direct, indirect, incidental, special, or consequential damages arising from your use of Fovi, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of any content posted, emailed, transmitted, or otherwise made available via Fovi.

##### 11. Indemnification  \n
You agree to indemnify and hold Fovi LLC and its affiliates, officers, agents, employees, and licensors harmless from any claim or demand, including reasonable attorneys’ fees, made by any third party due to or arising out of your use of Fovi, your violation of these Terms of Service, or your violation of any rights of another.

##### 12. Modifications  \n
Fovi LLC reserves the right to modify or amend these Terms of Service at any time, without notice. Your continued use of Fovi following any such modifications constitutes your acceptance of the modified Terms of Service.

##### 13. Governing Law  \n
These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of the jurisdiction in which Fovi LLC operates.

##### 14. Entire Agreement  \n
These Terms of Service and any policies or operating rules posted by us on the Fovi website or application constitute the entire agreement and understanding between you and us. These Terms of Service govern your use of the Fovi website or application and supersede any prior or contemporaneous agreements, communications, and proposals, whether oral or written, between you and us (including, but not limited to, any prior versions of the Terms of Service).
